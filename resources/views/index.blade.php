...
<section class="banner-area relative" id="home">
			...
			<section class="home-about-area section-gap">
				...
				<img class="about-img" src="{!! asset('assets/img/about-img.png') !!}" alt="">
			</section>
			<!-- End home-about Area -->
				...
				<div class="container">			
					<div class="row align-items-center">
						...
						<div class="col-lg-6 about-video-right justify-content-center align-items-center d-flex">
							<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid mx-auto" src="{!! asset('assets/img/play.png') !!}" alt=""></a>
						</div>
					</div>
				</div>	
			</section>
					...
					<div class="row">
						<div class="active-review-carusel">
							<div class="single-review item">
								<img src="{!! asset('assets/img/r1.png') !!}" alt="">
				...
				<div class="container">
					...
					<div class="row">	
						<div class="single-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="{!! asset('assets/img/b1.jpg') !!}" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="{!! asset('assets/img/user.png') !!}" alt="">
						...
						<div class="single-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="{!! asset('assets/img/b2.jpg') !!}" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="{!! asset('assets/img/user.png') !!}" alt="">
						...
						<div class="single-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="{!! asset('assets/img/b3.jpg') !!}" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="{!! asset('assets/img/user.png') !!}" alt="">
